...
import org.is70002024.market.repository.TransactionRepository;
...
/**
 * REST controller for managing {@link org.is70002024.market.domain.Transaction}.
 */
@RestController
...
public class TransactionResource {
        ...
        Optional<Transaction> result = transactionRepository
            ...
            .map(existingTransaction -> {
                ...
                if (transaction.getTransdate() != null) {
                    existingTransaction.setTransdate(transaction.getTransdate());
                }
    ...
    public ResponseEntity<List<Transaction>> getAllTransactions(
        ...
        if (eagerload) {
            page = transactionRepository.findAllWithEagerRelationships(pageable);
        } else {
