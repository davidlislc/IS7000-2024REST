...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSYTELOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSYTELOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSYTELOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSYTELOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSYTELOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSYTELOG actions', async () => {
      const arg = 42666;
