...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './service.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SERVICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICE actions', async () => {
      const arg = 42666;
