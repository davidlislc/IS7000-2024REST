...
import { deleteEntity, getEntity } from './service.reducer';
...
export const ServiceDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/service${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="is70002024App.service.delete.question">Are you sure you want to delete Service {serviceEntity.id}?</ModalBody>
      <ModalFooter>
