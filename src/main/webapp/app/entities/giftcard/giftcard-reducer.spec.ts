...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './giftcard.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GIFTCARD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GIFTCARD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GIFTCARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GIFTCARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GIFTCARD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GIFTCARD actions', async () => {
      const arg = 42666;
