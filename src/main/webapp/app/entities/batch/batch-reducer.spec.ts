...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './batch.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BATCH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BATCH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BATCH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BATCH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BATCH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BATCH actions', async () => {
      const arg = 42666;
