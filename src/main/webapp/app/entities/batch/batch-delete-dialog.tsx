...
import { deleteEntity, getEntity } from './batch.reducer';
...
export const BatchDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/batch${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="is70002024App.batch.delete.question">Are you sure you want to delete Batch {batchEntity.id}?</ModalBody>
      <ModalFooter>
