...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSCRIPTIONS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBSCRIPTIONS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBSCRIPTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBSCRIPTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBSCRIPTIONS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBSCRIPTIONS actions', async () => {
      const arg = 42666;
