...
import { deleteEntity, getEntity } from './wallet.reducer';
...
export const WalletDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/wallet${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="is70002024App.wallet.delete.question">Are you sure you want to delete Wallet {walletEntity.id}?</ModalBody>
      <ModalFooter>
