...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './wallet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WALLET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WALLET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WALLET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WALLET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WALLET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WALLET actions', async () => {
      const arg = 42666;
