          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('transdate')}>
                  Transdate <FontAwesomeIcon icon={getSortIconByFieldName('transdate')} />
                </th>
            ...
            <tbody>
              {transactionList.map((transaction, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {transaction.transdate ? <TextFormat type="date" value={transaction.transdate} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
