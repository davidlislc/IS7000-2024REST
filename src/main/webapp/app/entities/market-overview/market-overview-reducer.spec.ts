...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARKETOVERVIEW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MARKETOVERVIEW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MARKETOVERVIEW actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MARKETOVERVIEW actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MARKETOVERVIEW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MARKETOVERVIEW actions', async () => {
      const arg = 42666;
