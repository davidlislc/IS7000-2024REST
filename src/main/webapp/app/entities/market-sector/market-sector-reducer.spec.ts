...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARKETSECTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MARKETSECTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MARKETSECTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MARKETSECTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MARKETSECTOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MARKETSECTOR actions', async () => {
      const arg = 42666;
