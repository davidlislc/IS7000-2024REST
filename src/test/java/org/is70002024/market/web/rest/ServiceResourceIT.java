...
import static org.is70002024.market.domain.ServiceAsserts.*;
...
import org.is70002024.market.repository.ServiceRepository;
...
class ServiceResourceIT {
    ...
    public static Service createEntity() {
        return new Service().name(DEFAULT_NAME).level(DEFAULT_LEVEL).interval(DEFAULT_INTERVAL).price(DEFAULT_PRICE);
    }
    ...
    public static Service createUpdatedEntity() {
        return new Service().name(UPDATED_NAME).level(UPDATED_LEVEL).interval(UPDATED_INTERVAL).price(UPDATED_PRICE);
    }
    ...
    void putExistingService() throws Exception {
        ...
        updatedService.name(UPDATED_NAME).level(UPDATED_LEVEL).interval(UPDATED_INTERVAL).price(UPDATED_PRICE);
    ...
    void partialUpdateServiceWithPatch() throws Exception {
        ...
        partialUpdatedService.interval(UPDATED_INTERVAL);
    ...
    void fullUpdateServiceWithPatch() throws Exception {
        ...
        partialUpdatedService.name(UPDATED_NAME).level(UPDATED_LEVEL).interval(UPDATED_INTERVAL).price(UPDATED_PRICE);
